 ...
 */
export function extractMfaToken(req) {
 ...
 */
export function validateStringFieldAndThrow(value, fieldName) {
 ...
 */
export function validateArrayFieldAndThrow(value, fieldName) {
 ...
 */
export function validateVerificationCredentialAndThrow(body) {
    const bodyObj = body;
    const hasOtp = "otp" in bodyObj && typeof bodyObj.otp === "string" && bodyObj.otp !== "";
    const hasOob = "oobCode" in bodyObj &&
        typeof bodyObj.oobCode === "string" &&
        bodyObj.oobCode !== "" &&
        "bindingCode" in bodyObj &&
        typeof bodyObj.bindingCode === "string" &&
        bodyObj.bindingCode !== "";
    const hasRecovery = "recoveryCode" in bodyObj &&
        typeof bodyObj.recoveryCode === "string" &&
        bodyObj.recoveryCode !== "";
    if (!hasOtp && !hasOob && !hasRecovery) {
        throw new InvalidRequestError("Missing verification credential (otp, oobCode+bindingCode, or recoveryCode required)");
    }
    return bodyObj;
}
/**
 ...
 */
export function extractPathParam(pathname, paramName) {
