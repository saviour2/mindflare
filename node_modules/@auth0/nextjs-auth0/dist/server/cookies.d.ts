...
export declare function encrypt(payload: jose.JWTPayload, secret: string, expiration: number, additionalHeaders?: {
    iat: number;
    uat: number;
    exp: number;
}): Promise<string>;
export declare function decrypt<T>(cookieValue: string, secret: string, options?: jose.JWTDecryptOptions, throwOnJWEErrors?: boolean): Promise<jose.JWTDecryptResult<T> | null>;
/**
 ...
 */
export declare function getChunkedCookie(name: string, reqCookies: RequestCookies, isLegacyCookie?: boolean): string | undefined;
/**
 ...
 */
export declare function deleteChunkedCookie(name: string, reqCookies: RequestCookies, resCookies: ResponseCookies, isLegacyCookie?: boolean, options?: Pick<CookieOptions, "domain" | "path">): void;
/**
 ...
 */
export declare function addCacheControlHeadersForSession(res: NextResponse): void;
/**
 ...
 */
export declare function deleteCookie(resCookies: ResponseCookies, name: string, options?: Pick<CookieOptions, "domain" | "path">): void;
