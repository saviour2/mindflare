...
import { AccessTokenForConnectionOptions, AuthorizationParameters, BackchannelAuthenticationOptions, ConnectAccountOptions, CustomTokenExchangeOptions, CustomTokenExchangeResponse, GetAccessTokenOptions, LogoutStrategy, SessionData, SessionDataStore, StartInteractiveLoginOptions } from "../types/index.js";
...
export declare class Auth0Client {
     ...
     * This method can be used in middleware and `getServerSideProps`, API routes in the **Pages Router**.
     */
    getAccessTokenForConnection(options: AccessTokenForConnectionOptions, req: PagesRouterRequest | NextRequest | Request | undefined, res: PagesRouterResponse | NextResponse | undefined): Promise<{
        token: string;
        expiresAt: number;
    }>;
    /**
     ...
     */
    customTokenExchange(options: CustomTokenExchangeOptions): Promise<CustomTokenExchangeResponse>;
    /**
     ...
     */
    updateSession(req: PagesRouterRequest | NextRequest | Request, res: PagesRouterResponse | NextResponse | Response, session: SessionData): Promise<void>;
    /**
     * updateSession updates the session of the currently authenticated user. If the user does not have a session, an error is thrown.
     *
     ...
     */
    connectAccount(options: ConnectAccountOptions): Promise<NextResponse>;
     ...
     */
    createFetcher<TOutput extends Response = Response>(req: PagesRouterRequest | NextRequest | Request | undefined, options: {
