...
export declare const appRouteHandlerFactory: (client: Auth0Client) => WithApiAuthRequiredAppRoute;
export declare const pageRouteHandlerFactory: (client: Auth0Client) => WithApiAuthRequiredPageRoute;
