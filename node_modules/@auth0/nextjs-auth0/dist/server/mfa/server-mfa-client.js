...
export class ServerMfaClient {
    ...
    async challenge(options) {
        return this.authClient.mfaChallenge(options.mfaToken, options.challengeType, options.authenticatorId);
    }
    /**
    ...
    async verify(arg1, arg2, arg3) {
        ...
        if (arg1 instanceof NextRequest) {
            ...
            await this.authClient.cacheTokenFromMfaVerify(result, arg3.mfaToken, arg1.cookies, arg2.cookies);
            return result;
        }
        else {
            ...
            await this.authClient.cacheTokenFromMfaVerify(result, arg1.mfaToken, cookieStore, cookieStore);
            return result;
        }
    }
}
